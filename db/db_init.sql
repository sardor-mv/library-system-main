...
VALUES(2, 'admin', '$hashcode for password', 'admin@gmail.com', 'Admin', 'Admin', TRUE, FALSE, TRUE, 1, NOW(), 1, NOW());

/*General user - member*/
INSERT INTO account(account_id, username, password, email, first_name, last_name, active_status, deleted_status, immutable_status, creator, creation_date, updater, update_date)
VALUES(3, 'test', '$hashcode for password', 'test@naver.com', 'Test', 'Test', TRUE, FALSE, TRUE, 1, NOW(), 1, NOW());
